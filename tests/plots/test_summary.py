...
def test_random_summary():
    ...
    np.random.seed(0)
    fig = plt.figure()
    baby_shap.summary_plot(np.random.randn(20, 5), show=False)
    plt.tight_layout()
    return fig
...
def test_random_summary_with_data():
    ...
    np.random.seed(0)
    fig = plt.figure()
    baby_shap.summary_plot(np.random.randn(20, 5), np.random.randn(20, 5), show=False)
    plt.tight_layout()
    return fig
...
def test_random_multi_class_summary():
    ...
    np.random.seed(0)
    fig = plt.figure()
    baby_shap.summary_plot(
        [np.random.randn(20, 5) for i in range(3)], np.random.randn(20, 5), show=False
    )
    plt.tight_layout()
    return fig
...
def test_random_summary_bar_with_data():
    ...
    fig = plt.figure()
    baby_shap.summary_plot(
        np.random.randn(20, 5), np.random.randn(20, 5), plot_type="bar", show=False
    )
    plt.tight_layout()
    return fig
...
def test_random_summary_dot_with_data():
    ...
    fig = plt.figure()
    baby_shap.summary_plot(
        np.random.randn(20, 5), np.random.randn(20, 5), plot_type="dot", show=False
    )
    plt.tight_layout()
    return fig
...
def test_random_summary_violin_with_data():
    ...
    fig = plt.figure()
    baby_shap.summary_plot(
        np.random.randn(20, 5), np.random.randn(20, 5), plot_type="violin", show=False
    )
    plt.tight_layout()
    return fig
...
def test_random_summary_with_log_scale():
    ...
    np.random.seed(0)
    fig = plt.figure()
    baby_shap.summary_plot(np.random.randn(20, 5), use_log_scale=True, show=False)
    plt.tight_layout()
    return fig
