...
def test_approximate_interactions():
    ...
    interactions_no_features = approximate_interactions(
        0, shap_values, X_no_string_features
    )
    interactions_one_string_feature = approximate_interactions(
        0, shap_values, X_one_string_feature
    )
    interactions_two_string_feature = approximate_interactions(
