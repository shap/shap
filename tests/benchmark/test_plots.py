...
def test_plot_functions(mock_pl, mock_matplotlib, mock_models, mock_metrics, mock_methods, mock_get_attr, mock_run):
    ...
    # Mock Human Data
    mock_run.return_value = [(("data", "mod", "meth1", "m_hum"), (np.array([1.0, 2.0]), np.array([[0.5, 0.6], [0.1, 0.2]])))]
...
def test_plot_grids(mock_html, mock_pl, mock_models, mock_metrics, mock_methods, mock_plot_human, mock_plot_curve, mock_make_grid, mock_run, tmp_path):
    ...
    mock_make_grid.return_value = (
        ["meth1"], 
        ["m_std", "human_m", "runtime"], 
