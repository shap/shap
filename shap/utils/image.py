...
def is_empty(path):
    ...
    if os.path.exists(path) and not os.path.isfile(path):
        ...
        if not os.listdir(path):
            empty = True
            print(
                "'test_images' folder is empty. Please place images to be tested in this folder."
            )
    else:
        empty = True
        print(
...
def display_grid_plot(
    list_of_captions, list_of_images, max_columns=4, figsize=(20, 20)
):
    """
