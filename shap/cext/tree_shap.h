...
inline bool category_in_threshold_xgb(float threshold, float category) {
...
inline unsigned tree_split_child(
    int split_type, float threshold, float feature_value, unsigned left_child, unsigned right_child
) {
    if (split_type == 0) {
