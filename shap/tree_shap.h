...
// struct Node {
//   int cl, cr, cd, pnode, feat, pfeat; // uint_16
//   tfloat thres, value;
//   char from_flag;
// };
...
//   ofstream myfile;
// //   std::ofstream out("/homes/gws/hughchen/shap/out.txt");
// //   std::streambuf *coutbuf = std::cout.rdbuf(); //save old buf
// //   std::cout.rdbuf(out.rdbuf()); //redirect std::cout to out.txt!  
//   if (DEBUG2) {
// //     myfile.open ("/homes/gws/hughchen/shap/out.txt",fstream::app);
//     std::cout << "Entering tree_shap_indep\n";
...
//    */
// //   Node *mytree;
// //   mytree = new Node[num_nodes];
// //   for (unsigned l = 0; l < num_nodes; ++l) {
// //     mytree[l].cl = children_left[l];
// //     mytree[l].cr = children_right[l];
// //     mytree[l].cd = children_default[l];

// //     if (l == 0) {
// //       mytree[l].pnode = 0;
// //     }
// //     mytree[children_left[l]].pnode = l;
// //     mytree[children_left[l]].pfeat = features[l];
// //     mytree[children_right[l]].pnode = l;
// //     mytree[children_right[l]].pfeat = features[l];

// //     mytree[l].thres = thresholds[l];
// //     mytree[l].value = values[l];
// //     mytree[l].feat = features[l];
// //   }
// //   if (DEBUG2) {
// //     cout << "Hello" << "\n";
// //     cout << "mytree[0].cl" << mytree[0].cl << "\n";
// //     cout << "children_left[0]" << children_left[0] << "\n";
// //   }
// //   delete[] mytree;
//   float *pos_lst;
//   float *neg_lst;
...
//   pos_lst = new float[num_nodes];
//   neg_lst = new float[num_nodes];
//   node_stack = new int[max_depth];
//   feat_hist = new signed short[num_feats];
...
//   delete[] node_stack;
//   if (DEBUG2) {
//     cout << "Closing and exiting program\n";  
// //     myfile.close();
//   }
// }
...
//                            float *memoized_weights, int *node_stack) {
