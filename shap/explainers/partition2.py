...
import queue
from ..common import assert_import, record_import_error, safe_isinstance, Explanation
...
class PartitionExplainer2():
    
    def __init__(self, model, masker, partition_tree, output_names=None):
    ...
    def __call__(self, X, y=None, npartitions=100, interaction_tolerance=0, output_indexes=None, batch_size=10, hierarchical=False):
        ...
        if not hierarchical:
            ...
            e = Explanation(
                self.expected_value, v, X, feature_names=feature_names, output_shape=output_shape,
    ...
    def explain(self, x, output_type, npartitions, output_indexes,
        ...
        if output_type == "hierarchical":
            oinds = self.single_context_owen(x, npartitions, output_indexes, interaction_tolerance, context, silent)
            ...
            oinds = self.owen(x, npartitions, output_indexes, interaction_tolerance, context, batch_size, silent)
