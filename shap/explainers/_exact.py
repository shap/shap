...
class Exact(Explainer):
    ...
    def explain_row(self, *row_args, max_evals, main_effects, error_bounds, batch_size, outputs, interactions, silent):
        ...
        if getattr(self.masker, "clustering", None) is None:
            ...
            # Shapley values
            if interactions is False or interactions == 1: # pylint: disable=literal-comparison
            ...
            elif interactions is True or interactions == 2: # pylint: disable=literal-comparison
        ...
        if main_effects or interactions is True or interactions == 2: # pylint: disable=literal-comparison
            if inds is None:
