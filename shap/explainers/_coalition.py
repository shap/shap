...
class CoalitionExplainer(Explainer):
    ...
    def _build_partition_structure(self) -> None:
        ...
        # Step 2: stream combinations and intern unique masks
    ...
    def explain_row(
        ...
        *row_args: Any,
        ...
        # Step 2: compute model results for all unique masks in one batched call
        ...
        # Step 3: implement Owen values weighting
