...
NB_MODULE(_cutils, m)
{
    ...
    m.def("compute_grey_code_row_values_st", &compute_grey_code_row_values_st_1d, "row_values"_a, "mask"_a, "inds"_a, "outputs"_a, "shapley_coeff"_a, "extended_delta_indexes"_a, "noop_code"_a, "Compute Shapley-Taylor row values for the grey code algorithm in 1D");
    m.def("compute_grey_code_row_values_st", &compute_grey_code_row_values_st_2d, "row_values"_a, "mask"_a, "inds"_a, "outputs"_a, "shapley_coeff"_a, "extended_delta_indexes"_a, "noop_code"_a, "Compute Shapley-Taylor row values for the grey code algorithm in 2D");
