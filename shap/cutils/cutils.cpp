...
NB_MODULE(_cutils, m)
{
    ...
    m.def("init_masks", &masks::init_masks, "cluster_matrix"_a.noconvert(), "M"_a, "indices_row_pos"_a.noconvert(), "indptr"_a.noconvert(), "Initialize the masks for the kernel explainer algorithm");
    m.def("rec_fill_masks", &masks::rec_fill_masks, "cluster_matrix"_a.noconvert(), "indices_row_pos"_a.noconvert(), "indices"_a.noconvert(), "M"_a, "ind"_a, "Fill the masks for the partition explainer algorithm");
