...
class TeacherForcingLogits(Model):
    def __init__(self, model, tokenizer=None, generation_function_for_target_sentence_ids=None, text_similarity_model=None, text_similarity_tokenizer=None, device=None):
        ...
        cases (model is function) it expects a text_similarity_model and text_similarity_tokenizer to approximate log odd scores
    ...
    def get_output_names(self):
        """ Gets the output tokens from target sentence ids using the text_similarity_tokenizer.
        """
