"""
Direct test of LSTM integration into PyTorch DeepExplainer
"""
...
print("="*80)
print("PyTorch LSTM Integration Test")
print("="*80)
...
print(f"\nResults:")
print(f"  Expected Δc (sum): {output_diff:.6f}")
...
print(f"  ✓ Batch size correct: {shap_values.shape[0] == 1}")
print(f"  ✓ Feature size correct: {shap_values.shape[1] == input_size + 2 * hidden_size}")
