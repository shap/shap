...
def run_3d_benchmark():
    ...
    exp = shap.Explanation(values=values, data=data, feature_names=feature_names, output_names=output_names)
    ...
    try:
        ...
        print("❌ CRASH DETECTED (Expected on old master branch)")
...
def run_2d_benchmark():
    ...
    exp = shap.Explanation(values=values, data=data, feature_names=feature_names)
